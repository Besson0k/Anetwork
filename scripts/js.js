$(document).ready(function () {
    ...
    function closeMenu() {
        ...
        $('.home-page__left-phone').removeClass('home-page__left-phone--shifted-center');
        $('.home-page__watch-right').removeClass('home-page__watch-right--down');
        $('.home-page__center-phone').removeClass('home-page__center-phone--shifted-center');
        $('.home-page__center-phone').removeClass('home-page__center-phone--shifted');
